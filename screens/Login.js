  ...
  return (
    <KeyboardAvoidingWrapper>
      <StyledContainer>
        ...
        <InnerContainer>
          <PageLogo resizeMode="cover" source={require('./../assets/img/party.png')} />
          {/* <PageTitle>White Tents</PageTitle> */}
          <PageTitle>Event Planner App</PageTitle>         
           <SubTitle> Transforming Your Vision into Unforgettable Experiences</SubTitle>
              ...
              <StyledFormArea>
                ...
                {!googleSubmitting && (
                  <StyledButton onPress={handleGoogleSignin} google={true}>
                    ...
                    <ButtonText style= "color:black" google={true}>Sign in with Google</ButtonText>
                  </StyledButton>
                )}
                {googleSubmitting && (
